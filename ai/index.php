...
<head>
    ...
    <title>Ai - X0 All KaiOS</title>

 <meta property="og:image" content="https://x0.rf.gd/a/ai-image-genrator/gen.php?prompt=X0-Store-Ai&width=600&height=300" />

  <link rel="icon" href="https://x0.rf.gd/a/ai-image-genrator/gen.php?prompt=X0-Store-Ai &width=128&height=128" />
    ...
    <script>
        ...
        document.addEventListener('keydown', function(event) {
            ...
            // Right arrow - Social page
                ...
                window.location.href = 'https://x0.rf.gd/a/x0-all/multimedia/';
            }
            // Left arrow - Games page
            else if (event.key === 'ArrowLeft') {
                window.location.href = 'https://x0.rf.gd/a/x0-all/utility/';
            }
        });
    </script>

        
        <div id="ad-container" style="border: none;width: 100%; margin: 0 auto; position: relative; visibility: visible; background-color: transparent; overflow: auto;">
