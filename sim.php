...
<head>
	...
	<title>X0 Store KaiOS - Simulator</title>


  <meta property="og:description" content="Bookmark and launch websites or web apps on KaiOS." />

  <meta property="og:image" content="https://x0.rf.gd/a/ai-image-genrator/gen.php?prompt=x0-store-kaios-Simulator&width=800&height=400" />

  <link rel="icon" href="https://x0.rf.gd/a/ai-image-genrator/gen.php?prompt=x0-store-kaios-Simulator&width=128&height=128" />

<script type='text/javascript' src='http://pl26953579.profitableratecpm.com/f8/49/29/f8492924da30520cabdbb409c9928dec.js'></script>
</head>
...
<body>
	...
	<div class="container">
		...
		<div class="panel device">
			...
			<iframe id="appFrame" src="./" scrolling="yes"></iframe>
			<div class="brand"></div>
			<table class="keypad">
				<tr>
					<td>
